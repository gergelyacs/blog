...
## Big Bang 1: Rekordok interaktív helyreállítása
...
## Big Bang 2: Telekom adatok nem interaktív helyreállítása  
...
#### $Y^t$ rekonstruálása adott $t$ időpontban
...
\text{minimalizáld}\; \sum_{i=1}^n \sum_{j=1}^m c_{i,j}^t \times Y_{i,j}^t \\\\
