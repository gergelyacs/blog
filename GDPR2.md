...
1. **A lekérdezések auditálása** ([query auditing](http://theory.stanford.edu/~nmishra/SimulatableAuditing.pdf)), vagyis annak ellenőrzése, hogy a megválaszolandó lekérdezések lehetővé teszik-e valamely rekord rekonstruálását (pl. a fentihez hasonló egyenletrendszer megoldásával). A megközelítés alapfeltevése, hogy ismerjük a legjobb támadó algoritmust, és megnézzük, hogy az sikeres lenne-e ha megválaszolnánk a lekérdezéseket. Ez a GDPR-nak meg is felelhet, ha a támadás sikervalószínűsége nem túl magas és a tesztelt támadó algoritmus plauzibilis (vagyis a potenciális támadók a gyakorlatban valóban nem fognak ennél jobbat használni).
