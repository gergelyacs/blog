...
4. Ezek a támadások akkor is működhetnek, ha a [lekérdezések értékéhez véletlen zajt adunk hozzá](http://www.cse.psu.edu/~ads22/privacy598/papers/dn03.pdf) (query perturbation). Ebben az esetben egyenletek helyett egyenlőtlenségeket kell megoldani,  aminek  megoldása az első támadással az elméletileg *legrosszabb esetben* $O(n^5 \log^4 n)$ lépést igényel, míg a másodikkal csak $O(n\log n)$. Ha a zaj által okozott abszolút hiba legfeljebb $E$, akkor $n - 4E^2$ rekord [helyreállítható]((https://www.microsoft.com/en-us/research/wp-content/uploads/2008/08/dy08.pdf)), ahol $n$ a rekordok száma az adatbázisban. Pl. ha $n=256$ és $E=3$, akkor 220 rekord helyreállítható. Viszont érdekes módon $E > \sqrt{n}$ torzítás már megakadályozza a rekordok visszaállítását.
