...
Ebben a posztban megmutatjuk, hogy statisztikai/összesített adatokból rekonstruálhatók személyes adatok (pontosabban egyének rekordjai egy adatbázisban amin az összesített adatot számolták), és  így **aggregált (összesített) adat  is lehet személyes adat, akár még a GDPR [4. preambulumának](https://www.privacy-regulation.eu/hu/4.htm) értelmezésében is**. Példaként megmutatjuk, hogy ha egy telekom cég kiadná a mobiltelefon tornyok látogatottságát az idő függvényében (vagyis minden egyes toronynál levő előfizetők számát óránként), akkor ebből az aggregált adatból az egyes előfizetők által meglátogatott tornyok (helyek) listája közel 80%-os pontossággal rekonstruálható. Így az ilyen aggregált adat lehet személyes (sőt akár érzékeny), és ebben az esetben az aggregált adatok megfelelő anonimizációja/torzítása lehet szükséges.
...
Mivel a rekonstrukciós pontosság magas, a támadás [sikervalószínűsége](http://blog.crysys.hu/2017/07/628/) elég nagy. Így ha a támadás plauzibilis (a támadó valóban hozzáfér a 2. táblázathoz és a személyek közösség profiljához), akkor a lekérdezések összessége személyes adatnak minősülhet a GDPR szerint. 
